import{_}from"./plugin-vue_export-helper.2100c508.js";import{o as s,p as r,s as e,F as c,y as h,x as I,z as C,A as L,C as u,b as x}from"./vendor.52d332d0.js";var M="./dist/1.1e569f5d.png",j="./dist/2.5b236776.png",y="./dist/3.09184d2d.png",X="./dist/4.c7e85448.png",k="./dist/5.576fdde9.png",S="./dist/6.245c48c6.png",A="./dist/7.b6dd2616.png",V="./dist/8.97a86271.png",T="./dist/9.8d63667f.png",R="./dist/10.87b14baf.png",N="./dist/11.36c3226e.png",U="./dist/12.fa9fb874.png",D="./dist/13.c73abac6.png",P="./dist/14.53f27fd8.png",H="./dist/15.78952b03.png",B="./dist/16.8fffc80f.png",O="./dist/17.8c35e179.png",E="./dist/02.39c76b70.png",z="./dist/06.096675f7.png",G="./dist/11.400006d6.jpg",Y="./dist/17.aeaa7d96.png",q="./dist/19.35c75c8b.jpg",Z="./dist/21.90a09194.jpg",F="./dist/24.a577d7e6.jpg";let n={answer1:M,answer2:j,answer3:y,answer4:X,answer5:k,answer6:S,answer7:A,answer8:V,answer9:T,answer10:R,answer11:N,answer12:U,answer13:D,answer14:P,answer15:H,answer16:B,answer17:O},f={des2:E,des6:z,des11:G,des17:Y,des19:q,des21:Z,des24:F},v=[{title:"\u4E24\u6570\u4E4B\u548C",level:"\u7B80\u5355",describe:"\u7ED9\u5B9A\u4E00\u4E2A\u6574\u6570\u6570\u7EC4 nums\xA0\u548C\u4E00\u4E2A\u6574\u6570\u76EE\u6807\u503C target\uFF0C\u8BF7\u4F60\u5728\u8BE5\u6570\u7EC4\u4E2D\u627E\u51FA \u548C\u4E3A\u76EE\u6807\u503C target\xA0 \u7684\u90A3\xA0\u4E24\u4E2A\xA0\u6574\u6570\uFF0C\u5E76\u8FD4\u56DE\u5B83\u4EEC\u7684\u6570\u7EC4\u4E0B\u6807\u3002<br/>\u4F60\u53EF\u4EE5\u5047\u8BBE\u6BCF\u79CD\u8F93\u5165\u53EA\u4F1A\u5BF9\u5E94\u4E00\u4E2A\u7B54\u6848\u3002\u4F46\u662F\uFF0C\u6570\u7EC4\u4E2D\u540C\u4E00\u4E2A\u5143\u7D20\u5728\u7B54\u6848\u91CC\u4E0D\u80FD\u91CD\u590D\u51FA\u73B0\u3002\u4F60\u53EF\u4EE5\u6309\u4EFB\u610F\u987A\u5E8F\u8FD4\u56DE\u7B54\u6848\u3002",example:[{input:"\u8F93\u5165\uFF1Anums = [2,7,11,15], target = 9",output:"\u8F93\u51FA\uFF1A[0,1]",ex:"\u89E3\u91CA\uFF1A\u56E0\u4E3A nums[0] + nums[1] == 9 \uFF0C\u8FD4\u56DE [0, 1] \u3002"},{input:"\u8F93\u5165\uFF1Anums = [3,2,4], target = 6",output:"\u8F93\u51FA\uFF1A[1,2]"},{input:"\u8F93\u5165\uFF1Anums = [3,3], target = 6",output:"\u8F93\u51FA\uFF1A[0,1]"}],tip:["2 <= nums.length <= 104","-109 <= nums[i] <= 109","-109 <= target <= 109","\u53EA\u4F1A\u5B58\u5728\u4E00\u4E2A\u6709\u6548\u7B54\u6848"],answer:`// \u7B80\u5355\u7684\u53CC\u5C42\u5FAA\u73AF
/**
* @param { number[] } nums
* @param { number} target
* @return{ number[] }
...
var letterCombinationss = function (digits) {
    ...
    return res;
                   ...
                   <br><br>\u4F60\u53EF\u4EE5\u6309 \u4EFB\u610F\u987A\u5E8F \u8FD4\u56DE\u7B54\u6848 \u3002`,example:[{input:"\u8F93\u5165\uFF1Anums = [1,0,-1,0,-2,2], target = 0",output:"\u8F93\u51FA\uFF1A[[-2,-1,1,2],[-2,0,0,2],[-1,0,0,1]]"},{input:"\u8F93\u5165\uFF1Anums = [2,2,2,2,2], target = 8",output:"\u8F93\u51FA\uFF1A[[2,2,2,2]]"}],tip:["1 <= nums.length <= 200","-109 <= nums[i] <= 109","-109 <= target <= 109"],answer:"",answerImgUrl:""}];const $={data(){return{menuContral:!0,questionsIndex:[],answer:[]}},created(){let i=["\u{1F95D}","\u{1F954}","\u{1F349}"],a=["\u7B80\u5355","\u4E2D\u7B49","\u56F0\u96BE"];this.answer=v.slice(0,99),this.questionsIndex=v.map(o=>({level:o.level,title:i[a.indexOf(o.level)]+o.title}))},methods:{copyTo(i){document.execCommand("Copy",!0,i)||alert("\u597D\u50CF\u5931\u8D25\u4E86\uFF0C\u6362\u4E2A\u6D4F\u89C8\u5668\u8BD5\u8BD5")},scrollTo(i){this.menuContral=!this.menuContral;let a=document.getElementById(i);console.log(a.offsetTop),window.innerWidth<700?(console.log(1),window.scrollTo({left:0,top:a.offsetTop-24})):window.scrollTo({left:0,top:a.offsetTop})},showMenu(){return this.menuContral=!this.menuContral}},mounted(){var i=function(w,b){return w.sort((d,t)=>d-t),w};i([1,0,-1,0,-2,2]);let o=document.getElementsByClassName("context")[0];window.scrollTo({left:0,top:o.lastElementChild.offsetTop})}},m=i=>(C("data-v-5f019507"),i=i(),L(),i),W={id:"content",style:{"font-family":"Consolas"}},J={class:"menu"},K=m(()=>e("button",null,"\u83DC\u5355",-1)),Q=[K],ee=m(()=>e("div",null,"Made By LeeDeea",-1)),te=m(()=>e("div",null,null,-1)),ne=["title"],se={style:{display:"flex"}},re=["onClick"],ie=m(()=>e("header",{class:"header"},[e("div",null,"\u4ECE0\u5F00\u59CB\u7684LeetCode"),e("a",{target:"_blank href",href:"https://leetcode-cn.com/problemset/all/"},"\u6CE8\uFF1A\u4E00\u5207\u9898\u76EE\u4E3ALeeCode\u9898\u5E93\u8D44\u6E90")],-1)),le={class:"context"},ae=["id"],ue={class:"title"},pe={class:"describe"},oe=["innerHTML"],me=["src"],de={class:"example_wrap"},be={class:"example_all"},ge={class:"card"},ce={key:0},he=["src"],fe=["textContent"],we=["textContent"],xe=["innerHTML"],Ie={class:"tip"},ve={class:"card"},_e=m(()=>e("span",null,"\u63D0\u793A\uFF1A",-1)),Ce=["innerHTML"],Le={key:0,class:"answer"},Me=m(()=>e("div",null,"\u4EE3\u7801\u5B9E\u73B0\uFF1A",-1)),je=["src"],ye=["onClick"],Xe={key:1};function ke(i,a,o,w,b,d){return s(),r("div",W,[e("div",J,[e("div",{onClick:a[0]||(a[0]=t=>d.showMenu())},Q),ee,te]),e("section",{class:I(["side_Bar",b.menuContral?"sider_Hidden":""])},[(s(!0),r(c,null,h(b.questionsIndex,(t,p)=>(s(),r("div",{class:"select",key:p,title:t.title},[e("div",se,[e("div",{class:I(t.level=="\u7B80\u5355"?"ratio_easy":t.level=="\u4E2D\u7B49"?"ratio_mid":"ratio_hard"),style:{width:"15%"}},u(t.level),3),e("div",{style:{width:"85%",height:"20px",overflow:"hidden","text-overflow":"ellipsis","white-space":"nowrap"},onClick:l=>d.scrollTo(p+1)},u(p+1)+"."+u(t.title),9,re)])],8,ne))),128))],2),e("div",null,[ie,e("aside",le,[(s(!0),r(c,null,h(b.answer,(t,p)=>(s(),r("div",{id:`${p+1}`,class:"quisition",key:p},[e("div",ue,u(p+1)+"."+u(t.title),1),e("div",pe,[e("div",{innerHTML:t.describe},null,8,oe),e("div",null,[t.desImg?(s(),r("img",{key:0,src:t.desImg,alt:""},null,8,me)):x("",!0)])]),e("div",de,[e("div",be,[(s(!0),r(c,null,h(t.example,(l,g)=>(s(),r("div",{class:"example",key:g},[e("span",ge,[e("span",null,"\u793A\u4F8B"+u(g+1)+"\uFF1A",1),e("div",null,[l.img?(s(),r("p",ce,[e("img",{src:l.img,alt:""},null,8,he)])):x("",!0),e("p",{textContent:u(l.input)},null,8,fe),e("p",{textContent:u(l.output)},null,8,we),l.ex?(s(),r("p",{key:1,innerHTML:l.ex},null,8,xe)):x("",!0)])])]))),128))]),e("div",Ie,[e("span",ve,[_e,(s(!0),r(c,null,h(t.tip,(l,g)=>(s(),r("li",{key:g},[e("span",{innerHTML:l},null,8,Ce)]))),128))])])]),t.answerImgUrl?(s(),r("div",Le,[Me,e("img",{src:t.answerImgUrl,alt:""},null,8,je),e("button",{onClick:l=>d.copyTo(t.answer)},"\u590D\u5236",8,ye)])):(s(),r("div",Xe,"\u5F85\u89E3\u9898.."))],8,ae))),128))])])])}var Ve=_($,[["render",ke],["__scopeId","data-v-5f019507"]]);export{Ve as default};
