import{_}from"./plugin-vue_export-helper.2100c508.js";import{o as s,u as r,x as e,A as c,D as h,N as I,E as C,G as L,J as u,z as x}from"./vendor.67723c31.js";var M="./dist/1.1e569f5d.png",j="./dist/2.5b236776.png",y="./dist/3.09184d2d.png",X="./dist/4.c7e85448.png",k="./dist/5.576fdde9.png",S="./dist/6.245c48c6.png",A="./dist/7.b6dd2616.png",V="./dist/8.97a86271.png",T="./dist/9.8d63667f.png",R="./dist/10.87b14baf.png",N="./dist/11.36c3226e.png",D="./dist/12.fa9fb874.png",U="./dist/13.c73abac6.png",P="./dist/14.53f27fd8.png",H="./dist/15.78952b03.png",E="./dist/16.8fffc80f.png",O="./dist/17.8c35e179.png",B="./dist/02.39c76b70.png",G="./dist/06.096675f7.png",z="./dist/11.400006d6.jpg",Y="./dist/17.aeaa7d96.png",q="./dist/19.35c75c8b.jpg",Z="./dist/21.90a09194.jpg",$="./dist/24.a577d7e6.jpg";let n={answer1:M,answer2:j,answer3:y,answer4:X,answer5:k,answer6:S,answer7:A,answer8:V,answer9:T,answer10:R,answer11:N,answer12:D,answer13:U,answer14:P,answer15:H,answer16:E,answer17:O},f={des2:B,des6:G,des11:z,des17:Y,des19:q,des21:Z,des24:$},v=[{title:"\u4E24\u6570\u4E4B\u548C",level:"\u7B80\u5355",describe:"\u7ED9\u5B9A\u4E00\u4E2A\u6574\u6570\u6570\u7EC4 nums\xA0\u548C\u4E00\u4E2A\u6574\u6570\u76EE\u6807\u503C target\uFF0C\u8BF7\u4F60\u5728\u8BE5\u6570\u7EC4\u4E2D\u627E\u51FA \u548C\u4E3A\u76EE\u6807\u503C target\xA0 \u7684\u90A3\xA0\u4E24\u4E2A\xA0\u6574\u6570\uFF0C\u5E76\u8FD4\u56DE\u5B83\u4EEC\u7684\u6570\u7EC4\u4E0B\u6807\u3002<br/>\u4F60\u53EF\u4EE5\u5047\u8BBE\u6BCF\u79CD\u8F93\u5165\u53EA\u4F1A\u5BF9\u5E94\u4E00\u4E2A\u7B54\u6848\u3002\u4F46\u662F\uFF0C\u6570\u7EC4\u4E2D\u540C\u4E00\u4E2A\u5143\u7D20\u5728\u7B54\u6848\u91CC\u4E0D\u80FD\u91CD\u590D\u51FA\u73B0\u3002\u4F60\u53EF\u4EE5\u6309\u4EFB\u610F\u987A\u5E8F\u8FD4\u56DE\u7B54\u6848\u3002",example:[{input:"\u8F93\u5165\uFF1Anums = [2,7,11,15], target = 9",output:"\u8F93\u51FA\uFF1A[0,1]",ex:"\u89E3\u91CA\uFF1A\u56E0\u4E3A nums[0] + nums[1] == 9 \uFF0C\u8FD4\u56DE [0, 1] \u3002"},{input:"\u8F93\u5165\uFF1Anums = [3,2,4], target = 6",output:"\u8F93\u51FA\uFF1A[1,2]"},{input:"\u8F93\u5165\uFF1Anums = [3,3], target = 6",output:"\u8F93\u51FA\uFF1A[0,1]"}],tip:["2 <= nums.length <= 104","-109 <= nums[i] <= 109","-109 <= target <= 109","\u53EA\u4F1A\u5B58\u5728\u4E00\u4E2A\u6709\u6548\u7B54\u6848"],answer:`// \u7B80\u5355\u7684\u53CC\u5C42\u5FAA\u73AF
/**
* @param { number[] } nums
* @param { number} target
* @return{ number[] }
